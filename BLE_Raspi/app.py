...
VivaldiBaseUrl = "http://127.0.0.1:5000/"
...
class PowerControlCharacteristic(Characteristic):
    ...
    def ReadValue(self, options):
        ...
        try:
            ...
            readSTR = ""
            readSTR = "TVmotor;" + todos["TVmotor"]
            readSTR += "_Table1Motor;" + todos["Table1Motor"] 
            readSTR += "_Table2Motor;" + todos["Table2Motor"]
            readSTR += "_Table3Motor;" + todos["Table3Motor"]
            readSTR += "_KahveMotor;" + todos["KahveMotor"]
            readSTR += "_Led1-Red;" + todos["Led1-Red"]
            readSTR += "_Led1-Green;" + todos["Led1-Green"]
            readSTR += "_Led1-Blue;" + todos["Led1-Blue"]
            readSTR += "_Led2-Red;" + todos["Led2-Red"]
            readSTR += "_Led2-Green;" + todos["Led2-Green"]
            readSTR += "_Led2-Blue;" + todos["Led2-Blue"]
            readSTR += "_Led3-Red;" + todos["Led3-Red"]
            readSTR += "_Led3-Green;" + todos["Led3-Green"]
            readSTR += "_Led3-Blue;" + todos["Led3-Blue"]
            """            
            for todo in todos:
                myvalues += todo
            ...
            """            
            #myread = myread + " " + bytearray(res.json()["Table1Motor"], encoding="utf8")
            self.value = bytearray(readSTR, encoding="utf-8")
            #, "Table1Motor", "Table2Motor", "Table3Motor"
